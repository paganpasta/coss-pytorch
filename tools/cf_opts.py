...
def parse_opt():
    ...
    parser.add_argument('--closek-info',
                        default=None,
                        type=str)
    
    parser.add_argument('--nearest-k',
                        default=7,
                        type=int)
    
    parser.add_argument('--total-k',
                        default=32,
                        type=int)
    ...
    parser.add_argument('--sampler',
                        default=None,
                        required=True,
                        choices=['cf','cluster', 'cluster+cf'])
    
    parser.add_argument('--l_0',
                        default=1.0,
                        type=float)
    parser.add_argument('--l_1',
                        default=0.5,
                        type=float)
    ...
    parser.add_argument('--aug', choices=['moco_v1', 'moco_v2', 'swav', 'simclr', 'oodd'], default='moco_v1')
