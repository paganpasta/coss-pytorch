...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', bn_coss=False, num_classes=10):
        ...
        self.bn_coss = nn.BatchNorm1d(num_filters[3] * block.expansion) if bn_coss else nn.Identity()
