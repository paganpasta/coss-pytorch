...
#MOCO-v3 PASCAL VOC
#python3 train_net.py --config-file configs/pascal_voc_R_50_C4_24k_moco.yaml --num-gpus 4 --resume MODEL.WEIGHTS ./weights/mocov3_coss_r18.pkl  MODEL.RESNETS.DEPTH 18 MODEL.RESNETS.RES2_OUT_CHANNELS 64 OUTPUT_DIR ./output/bingo_config/pascal_voc/moco_v3/resnet18/coss
